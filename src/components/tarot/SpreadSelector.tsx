...
import { getLocalizedSpread } from '@/lib/tarotLocalization';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-2 text-amber-200">
        {messages.spread.title}
      </h2>
      <p className="text-center text-purple-300/70 mb-8">
        {messages.spread.description}
      </p>
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-purple-400">
                      {spread.cardCount} {messages.spread.cardsSuffix}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1">
                  {localizedSpread.positions.slice(0, 4).map((positionName, index) => (
                    <span
                      key={index}
                  ...
                  {localizedSpread.positions.length > 4 && (
